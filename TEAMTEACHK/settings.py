"""
Django settings for TEAMTEACHK project.
...
SECRET_KEY = 'django-insecure-uahfo^@*&edzufc9tn*16gmd#udysf5redua)eqo01)yh5r^i_'
...
WSGI_APPLICATION = 'TEAMTEACHK.wsgi.application'
